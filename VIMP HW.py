...
def store():
    ...
    g=q.replace("/","_",-1)
    df[1][0:][0:].to_csv("new{}.csv".format(g))
    sf=pd.read_csv("new{}.csv".format(g),encoding="ISO-8859-1")
    sf.to_sql("rail{}".format(g),con,if_exists='append')
    print("SUCCESSFUL")
